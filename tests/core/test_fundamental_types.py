...
def test_fundamental_types():
    expect = {
        "byte": [["255", b"\xff"], ["0", b"\x00"]],
        "u16": [["65535", b"\xff\xff"], ["0", b"\x00\x00"]],
        "u32": [["4294967295", b"\xff\xff\xff\xff"], ["0", b"\x00\x00\x00\x00"]],
        "u64": [
        ...
        "point": [
            [
                "02030405060708090a0b0c0d0e0f10"
                "1112131415161718191a1b1c1d1e1f20"
                "2122",
                bytes(range(2, 35)),
            ]
